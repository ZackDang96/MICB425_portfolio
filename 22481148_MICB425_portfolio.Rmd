...
**Figure 5.** Linear regression model of the abundance of Oceanospirillaceae across oxygen concentration using mothur analysis (**A**) and QIIME2 analysis (**B**), with  correspondingstatistical analysis of the abundance of Oceanospirillaceae across depth below. 
...
##Depth and nitrous oxide-dependent distribution of the denitrification gene nosZ throughout the Saanich Inlet
...
nosZ.RNA.10m = read_tsv("C:/Users/ZACK/Documents/MICB425_portfolio-master/treesapp_out_dir_10m_MetaT/final_outputs/marker_contig_map.tsv") %>% 
  select(Tax.RNA.10 = Confident_Taxonomy, Abund.RNA.10 = Abundance, Query)

nosZ.RNA.100m = read_tsv("C:/Users/ZACK/Documents/MICB425_portfolio-master/treesapp_out_dir_100m_MetaT/final_outputs/marker_contig_map.tsv") %>% 
  select(Tax.RNA.100 = Confident_Taxonomy, Abund.RNA.100 = Abundance, Query)

nosZ.RNA.120m = read_tsv("C:/Users/ZACK/Documents/MICB425_portfolio-master/treesapp_out_dir_120m_MetaT/final_outputs/marker_contig_map.tsv") %>% 
    select(Tax.RNA.120 = Confident_Taxonomy, Abund.RNA.120 = Abundance, Query)

nosZ.RNA.135m = read_tsv("C:/Users/ZACK/Documents/MICB425_portfolio-master/treesapp_out_dir_135m_MetaT/final_outputs/marker_contig_map.tsv") %>% 
    select(Tax.RNA.135 = Confident_Taxonomy, Abund.RNA.135 = Abundance, Query)
    
nosZ.RNA.150m = read_tsv("C:/Users/ZACK/Documents/MICB425_portfolio-master/treesapp_out_dir_150m_MetaT/final_outputs/marker_contig_map.tsv") %>% 
    select(Tax.RNA.150 = Confident_Taxonomy, Abund.RNA.150 = Abundance, Query)

nosZ.RNA.165m = read_tsv("C:/Users/ZACK/Documents/MICB425_portfolio-master/treesapp_out_dir_165m_MetaT/final_outputs/marker_contig_map.tsv") %>% 
    select(Tax.RNA.165 = Confident_Taxonomy, Abund.RNA.165 = Abundance, Query)

nosZ.RNA.200m = read_tsv("C:/Users/ZACK/Documents/MICB425_portfolio-master/treesapp_out_dir_200m_MetaT/final_outputs/marker_contig_map.tsv") %>% 
    select(Tax.RNA.200 = Confident_Taxonomy, Abund.RNA.200 = Abundance, Query)
  
  
    
nosZ.DNA.10m = read_tsv("C:/Users/ZACK/Documents/MICB425_portfolio-master/treesapp_out_dir_10m/final_outputs/marker_contig_map.tsv") %>% 
  select(Tax.DNA.10 = Confident_Taxonomy, Abund.DNA.10 = Abundance, Query)

nosZ.DNA.100m = read_tsv("C:/Users/ZACK/Documents/MICB425_portfolio-master/treesapp_out_dir_100m/final_outputs/marker_contig_map.tsv") %>% 
  select(Tax.DNA.100 = Confident_Taxonomy, Abund.DNA.100 = Abundance, Query)

nosZ.DNA.120m = read_tsv("C:/Users/ZACK/Documents/MICB425_portfolio-master/treesapp_out_dir_120m/final_outputs/marker_contig_map.tsv") %>% 
    select(Tax.DNA.120 = Confident_Taxonomy, Abund.DNA.120 = Abundance, Query)

nosZ.DNA.135m = read_tsv("C:/Users/ZACK/Documents/MICB425_portfolio-master/treesapp_out_dir_135m/final_outputs/marker_contig_map.tsv") %>% 
    select(Tax.DNA.135 = Confident_Taxonomy, Abund.DNA.135 = Abundance, Query)
    
nosZ.DNA.150m = read_tsv("C:/Users/ZACK/Documents/MICB425_portfolio-master/treesapp_out_dir_150m/final_outputs/marker_contig_map.tsv") %>% 
    select(Tax.DNA.150 = Confident_Taxonomy, Abund.DNA.150 = Abundance, Query)

nosZ.DNA.165m = read_tsv("C:/Users/ZACK/Documents/MICB425_portfolio-master/treesapp_out_dir_165m/final_outputs/marker_contig_map.tsv") %>% 
    select(Tax.DNA.165 = Confident_Taxonomy, Abund.DNA.165 = Abundance, Query)

nosZ.DNA.200m = read_tsv("C:/Users/ZACK/Documents/MICB425_portfolio-master/treesapp_out_dir_200m/final_outputs/marker_contig_map.tsv") %>% 
...
Hallam, S. J., Torres-Beltr�n, M., & Hawley, A. K. (2017). Monitoring microbial responses to ocean deoxygenation in a model oxygen minimum zone. Scientific Data, 4, 170158. doi:10.1038/sdata.2017.158

Hawley, A. K., Torres-Beltr�n, M., Zaikova, E., Walsh, D. A., Mueller, A., Scofield, M., . . . Hallam, S. J. (2017). A compendium of multi-omic sequence information from the Saanich Inlet water column. Scientific Data, 4, 170160. doi:10.1038/sdata.2017.160
...
Torres-Beltr�n, M., Hawley, A. K., Capelle, D., Zaikova, E., Walsh, D. A., Mueller, A., . . . Hallam, S. J. (2017). A compendium of geochemical information from the Saanich Inlet water column. Scientific Data, 4, 170159. doi:10.1038/sdata.2017.159
...
>>>>>>> b3a8f39dafd8af8ececd8f067c236b7a6a3060f5
