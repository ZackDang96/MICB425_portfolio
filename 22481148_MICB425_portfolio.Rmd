...
- compare genetic similarity/OTU similarity between pathogenic and non-pathogenic strains
- determine conserved pathogenicity associated genes/PAIs 
...
- The CFT073 genome is circular, 5 million-bp chromosomal sequence with seven times coverage.
- Selective pressure to conserve PAI in infection and host colonization
- The backbone is evolutionarily conserved through vertical gene transfer 
...
- Each type/species of E. coli possess combinations of island genes that confer its characteristic lifestyle or its pathogenicity. For example, the uropathogenic strain, CFT073 acquired an  island gene that allows it to infect the urinary tract and bloodstream without compromising its ability to colonize the intestine.
- "net result is a mosaic genome structure in which newly acquired genes in each of the E. coli types are placed into a framework made of genes that distinguishes E. coli from its closer relatives such as S. enterica"

####Do new questions arise from the results?

- How similar/different are pathogenic E. coli strains from other pathogens (ie. Shigella? Y. pestis)?
- How can species be defined to account for frequent gain and loss of accessory genes ??? cannot simply define species by phenotypic analysis and low resolution mapping alone
- Why hasn't there been any evidence of extensive genome reductions despite the fact that E.coli has been living commensualy in the intestinal system of animals, which are nutrient rich environments, for millions of years? 
...
- Ecotype: varying tissues types (each type of human cell has different receptors and secrete different and surrounding factors that make up the extracellular environment
- Ecotype in human body -> skin colour depends on the altitude; microbiota in digestive system -> diet;
